...
data class CompletionItem(
    ...
    /**
     * The LSP textEdit that specifies the exact range to replace. When present, performCompletion
     * must use this range instead of doing its own prefix scan — this is the only correct way to
     * handle completions where the replacement range covers more than just the typed prefix (e.g.
     * "con" typed but "const val" needs full replacement).
     */
