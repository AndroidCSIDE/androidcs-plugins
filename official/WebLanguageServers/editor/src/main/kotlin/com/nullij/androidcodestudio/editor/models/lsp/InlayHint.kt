...
/**
 * Inlay hint information from LSP server Inlay hints appear inline in the editor to show additional
 * information like parameter names, type annotations, etc.
 */
