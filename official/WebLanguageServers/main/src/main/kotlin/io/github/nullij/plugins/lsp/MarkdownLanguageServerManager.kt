 ...
 */
class MarkdownLanguageServerManager : PluginLanguageServerSpec {
    ...
    private var client: MarkdownLanguageClient? = null
    ...
    override fun start(): Boolean = runBlocking {
        ...
        try {
            val binFile = File("$PREFIX/vscode-markdown-language-server")
            ...
            val builder = if (nodeFile.exists() && binFile.exists()) {
                ...
                pb.command("vscode-markdown-language-server", "--stdio")
            }
            ...
            return@runBlocking if (initialized) {
                client = MarkdownLanguageClient(this@MarkdownLanguageServerManager)
                running = true
                true
            } else {
                stopInternal()
                ...
                JsonObject().apply {
                    add(
                        ...
                        JsonObject().apply {
                            ...
                            addProperty("languageId", "markdown")
