...
class BashLanguageServerManager : PluginLanguageServerSpec {
    ...
    companion object {
        ...
        private const val BASH_LS_EXECUTABLE = "/data/data/com.acside/files/usr/bin/bash-language-server"
    ...
    override fun start(): Boolean = runBlocking {
        ...
        try {
            ...
            val scriptFile = File(BASH_LS_EXECUTABLE)
            ...
            val builderWithCmd = if (nodeFile.exists() && scriptFile.exists()) {
                processBuilder.command(nodeFile.absolutePath, scriptFile.absolutePath, "start")
            } else if (scriptFile.exists()) {
                processBuilder.command(scriptFile.absolutePath, "start")
            } else {
                processBuilder.command("bash-language-server", "start")
            }
